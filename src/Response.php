...
{
    public const APNS_SUCCESS = 200;
    public const APNS_BAD_REQUEST = 400;
    public const APNS_AUTH_PROVIDER_ERROR = 403;
    public const APNS_METHOD_NOT_ALLOWED = 405;
    public const APNS_NOT_ACTIVE_DEVICE_TOKEN_ = 410;
    public const APNS_PAYLOAD_TOO_LARGE = 413;
    public const APNS_TOO_MANY_REQUESTS = 429;
    public const APNS_SERVER_ERROR = 500;
    public const APNS_SERVER_UNAVAILABLE = 503;
